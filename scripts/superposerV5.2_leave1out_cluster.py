...
parser.add_argument("-a", "--aligned_residues", type=int,
                    help="Minimum number of residues aligned to target pocket", required=True)
parser.add_argument("-r", "--RMSD_allowed", type=float,
                    help="Maximum RMSD allowed to alignments of minipockets to target pocket", required=True)
